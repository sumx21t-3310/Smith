...
{
    [Serializable, AddTypeMenu("TRecoil")]
    public class TRecoilGeneratorEngine : IRecoilGenerateEngine
    {
        [SerializeField] private float totalHeight = 1f;
        [SerializeField] private float maxWidth = 35f;
